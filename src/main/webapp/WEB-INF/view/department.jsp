						...
						<div class="tab-content bg-light p-4 p-md-5 ftco-animate"
								...
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch"
											style="background-image: url(resources/images/dept-1.jpg);"></div>
									</div>
									<div class="col-lg-8">
							...
							<div class="tab-pane fade" id="v-pills-2" role="tabpanel"
								...
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch"
											style="background-image: url(resources/images/dept-2.jpg);"></div>
									</div>
									<div class="col-md-8">
							...
							<div class="tab-pane fade" id="v-pills-3" role="tabpanel"
								...
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch"
											style="background-image: url(resources/images/dept-3.jpg);"></div>
									</div>
									<div class="col-md-8">
							...
							<div class="tab-pane fade" id="v-pills-4" role="tabpanel"
								...
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch"
											style="background-image: url(resources/images/dept-4.jpg);"></div>
									</div>
									<div class="col-md-8">
							...
							<div class="tab-pane fade" id="v-pills-5" role="tabpanel"
								...
								<div class="row departments">
									<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
										<div class="img d-flex align-self-stretch"
											style="background-image: url(resources/images/dept-5.jpg);"></div>
									</div>
									<div class="col-md-8">
